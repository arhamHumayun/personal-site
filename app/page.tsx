  ...
  return (
    <div className="flex flex-col items-center justify-center h-full">
      <div className="text-center space-y-6 max-w-2xl">
        <H1>Hey there! 👋</H1>
        <Lead>I&#39;m Arham Humayun, a Full-Stack Engineer with startup experience, specializing in backend development, AI systems, and distributed architectures.</Lead>
        <P>Explore my blog posts, check out my projects, or get in touch!</P>
